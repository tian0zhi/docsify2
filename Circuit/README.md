...
以下图为例解释该方法，
<p align="center">
        <img src="http://115.159.24.45:3000/Circuit/pic/Fig22.png" width="70%"/>
</p>
...
<p align="center">
        <img src="http://115.159.24.45:3000/Circuit/pic/Fig23.png" width="60%"/>
</p>
...
现在用$R_{11}$和$R_{22}$分别表示网孔1和网孔2的自阻,它们分别是网孔1和网孔2中所有电阻之和，即$R_{11}=R_1+R_2$，$R_{22}=R3+R2$；用$R_{12}$和$R_{21}$分别表示网孔1和网孔2的互阻,即两个网孔的共有电阻,本例中$R_{12}=R_{21}=-R_2$(两个网孔电流方向相反)。
